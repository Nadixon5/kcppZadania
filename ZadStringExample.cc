...
int main(){
    ...
    cout<<"Długość stringa jest równa: "<<lorem.size()<<endl;
    cout<<"Długość stringa jest równa: "<<lorem.length()<<endl;
    ...
    cout << "Pierwszy język: " << language1 << endl;
    cout << "Drugi język: " << language2 << endl;
    ...
    string okej = "lubię ";
    okej.append("Cpp?");
    cout<<"Czy wiedział Pan że "<<okej<<endl;
